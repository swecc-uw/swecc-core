...
# SWAG / infra/gateway nginx upstreams use stack-style DNS names
# (e.g. swecc_stack_server). deploy.sh creates standalone swarm services
# named "server", "bench-api", … — register this alias so routing works.
