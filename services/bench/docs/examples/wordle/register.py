"""
Register WordleEnv with the platform.
...
Usage:
    ...
    uv run python docs/examples/wordle/register.py --api http://prod-api:8000
    uv run python docs/examples/wordle/register.py --publish
"""
