...
if __name__ == "__main__":
    ...
    parser.add_argument("--minutes", type=int, default=60, help="Token expiration time in minutes")
    parser.add_argument("--verbose", action="store_true", help="Print debug info")

    args = parser.parse_args()

    token = generate_token(
        args.user_id, args.username, os.getenv("JWT_SECRET", args.secret), args.minutes
    )
