...
class TestReduceByTen(unittest.TestCase):
    ...
    def test_compact_data(self):
        ...
        container_1_compacted = [
            entry for entry in compacted_data if entry.container_name == "container_1"
        ]
        container_2_compacted = [
            entry for entry in compacted_data if entry.container_name == "container_2"
        ]
